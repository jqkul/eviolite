...
pub struct Evolution<T, Alg, Stat, Hof> where T: Solution, Alg: Algorithm<T>, Stat: GenerationStats<T>, Hof: HallOfFame<T> {
...
impl<T, Alg, Stat, Hof> Evolution<T, Alg, Stat, Hof> where T: Solution, Alg: Algorithm<T>, Stat: GenerationStats<T>, Hof: HallOfFame<T> {
    ...
    /// 
    /// [`Log`]: ./struct.Log.html
    pub fn run_for(self, n_gens: usize) -> Log<T, Stat, Hof> {
    ...
    ///  
    /// [`Log`]: ./struct.Log.html
    pub fn run_until<F>(self, predicate: F) -> Log<T, Stat, Hof> where F: FnMut(Generation<T, Stat, Hof>) -> bool {
    ...
    pub fn run_for_with<F>(mut self, n_gens: usize, mut callback: F) -> Log<T, Stat, Hof> where F: FnMut(Generation<T, Stat, Hof>) {
    ...
    pub fn run_until_with<F, G>(mut self, mut predicate: F, mut callback: G) -> Log<T, Stat, Hof> where F: FnMut(Generation<T, Stat, Hof>) -> bool, G: FnMut(Generation<T, Stat, Hof>) {
...
pub struct Log<T, Stat, Hof> where T: Solution, Stat: GenerationStats<T>, Hof: HallOfFame<T> {
...
#[derive(Clone, Copy)]
pub struct Generation<'a, T, Stat, Hof> where T: Solution, Stat: GenerationStats<T>, Hof: HallOfFame<T> {
